...
const AudioPlayer: React.FC<AudioPlayerProps> = ({
    ...
    const stop = () => {
        if (episode) {
            // Clear the playing state for this episode
                ...
                >
                    <div className="flex items-center mb-0">
                        ...
                        <div className="min-w-0 max-w-[120px]">
                            <p className={"uppercase text-[10px] pb-[2px] font-bold"}>
                    ...
                    <div className="flex items-center space-y-2 flex-1">
                        <div className="flex items-center space-x-1">
                            ...
                            >
                                {isLoading ? (
                                    <Play className="w-5 h-5 text-primary-foreground ml-0.5 animate-pulse"/>
                                ) : isPlaying ? (
                        ...
                        {/* Progress Bar */}
                        <div className="w-full flex items-center space-x-2 flex-1">
              <span className="text-xs text-muted-foreground w-12 text-right">
                {formatTime(currentTime)}
              </span>
                            <div
                                ref={progressRef}
                                className="flex-1 h-1 bg-white rounded-full cursor-pointer relative"
                ...
                {formatTime(duration)}
                    ...
                    <div className="grid grid-cols-1 h-[80px] min-w-[50px] border-l  border-white/20">
                        ...
                        >
                            ...
                            />
                            <p className={"text-xs w-[30px] select-none"}>
                        ...
                        >
                            ...
                            />
                            <p className={"text-xs w-[30px] select-none"}>
                                {(Math.round(playbackSpeed * 100) / 100).toFixed(2)}%
                            </p>
                            <Plus
                                width={15}
                                onClick={() => faster()}
                        ...
                        <div
                            ...
                            onClick={() => stop()}
                        >
                            <Square width={15} className={"cursor-pointer"}/>
                            <p className={"text-xs w-[30px] uppercase !select-none"}>Stop</p>
                        </div>
                    </div>
                </div>
            </div>
